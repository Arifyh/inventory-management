# Ikonik Inventory - Inventory Management System & Material Catalog

A premium inventory management and material catalog system designed specifically for **Ikonik Architecture** (Building Materials Store). The application features a premium visual interface blending a sand/cream background (`#f5f0e8`), architectural charcoal-black (`#0d0d0d`), and warm gold/bronze accents (`#8b6914`).
