...
const getPublicProducts = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error fetching public products", error: error.message });
  }
};
...
const getPublicProductById = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error fetching public product", error: error.message });
  }
};
...
const togglePublishStatus = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error toggling publish status", error: error.message });
  }
};
...
const setThumbnail = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error setting thumbnail", error: error.message });
  }
};
